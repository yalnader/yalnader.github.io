...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var num = readData("num");
        var snack = readData("snack");
        var birth = readData("birth");
        res.render('showResults', {results: [color, fruit, animal, snack, num, birth]});
        console.log([color, fruit, animal, snack, num , birth]);
    });
